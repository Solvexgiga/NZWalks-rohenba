...
namespace NZWalks_rohenba.API.Controllers
{
    ...
    public class WalksController : Controller
    {
        ...
        public WalksController(IWalkRepository walkRepsitory, IMapper mapper, IRegionRepository regionRepository, IWalkDifficultyRepository walkDifficultyRepository)
        {
